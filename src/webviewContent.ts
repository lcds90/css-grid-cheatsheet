...
export function getWebviewContent(
  ...
  <head>
	  ...
	  <meta http-equiv="Content-Security-Policy"
		  content="default-src 'none'; script-src ${cspSource}; style-src ${cspSource} '${webviewUiToolkitHash}'; img-src ${cspSource};">
	  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  
	  <title>CSS Cheatsheet</title>
  
	  <link rel="stylesheet" href="${stylePath}/generic.css">
	  <link rel="stylesheet" href="${stylePath}/flex.css">
	  <link rel="stylesheet" href="${stylePath}/grid.css">
  </head>
  ...
  <body>
	  ...
	  <nav class="containerSummaryList">
		  ...
		  <section>
				...
				<h2>Resources</h2>
				<ul>
					  <li><a href="https://css-tricks.com/snippets/css/a-guide-to-flexbox/" target="_blank" rel="noopener">A
							  Complete Guide to Flexbox</a></li>
					  <li><a href="https://www.samanthaming.com/flexbox30/" target="_blank" rel="noopener">Learn Flexbox with
							  30 Code Tidbits</a></li>
					  <li><a href="https://flexboxfroggy.com/" target="_blank" rel="noopener">Flexbox Froggy</a></li>
					  <li><a href="https://flexboxzombies.com/p/flexbox-zombies" target="_blank" rel="noopener">Flexbox
							  Zombies</a></li>
					  <li><a href="https://codingfantasy.com/games/flexboxadventure" target="_blank" rel="noopener">Flex Box
							  Adventure</a></li>
	  ...
	  <main>
		  ...
		  <div class="container">
			  ...
			  <h2 id="flexContainer">Flex Container</h2>
  
			  <div class="group">
				  <h3 id="flexDisplay">Display</h3>
  
				  <div class="row">
					  <div>
						  <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/display" target="_blank"
							  rel="noopener">display</a>: flex;
					  </div>
			  ...
			  <div class="group">
				  <h3 id="flexShorthand">Flex flow (shorthand)</h3>
  
				  <div class="row">
					  <div><a href="https://developer.mozilla.org/en-US/docs/Web/CSS/flex-flow" target="_blank"
							  rel="noopener">flex-flow</a>:
						  <span class="default">row nowrap;</span> <span class="shorthand-hint">(flex-direction
							  flex-wrap)</span>
					  </div>
				  </div>
			  </div>
			  ...
			  <div class="group">
				  <h3 id="flexDirection">Flex direction</h3>
  
				  <div class="row">
					  <div>
						  <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/flex-direction" target="_blank"
							  rel="noopener">flex-direction</a>: <span class="default">row</span>;
					  </div>
				  ...
				  <div class="interactive-playground flex-container">
					  ...
					  <button class="button" data-js-class="flex-direction-column-reverse"
						  type="button">column-reverse</button>
			  ...
			  <div class="group">
				  <h3 id="flexWrap">Flex wrap</h3>
  
				  <div class="row">
					  <div>
						  <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/flex-wrap" target="_blank"
							  rel="noopener">flex-wrap</a>: <span class="default">nowrap</span>;
					  </div>
				  ...
				  <div class="interactive-playground flex-container">
					  ...
					  <div class="interactive-playground flex-container">
						  ...
						  <button class="button" data-js-class="flex-wrap-wrap-reverse"
							  type="button">wrap-reverse</button>
			  ...
			  <div class="group">
				  ...
				  <div class="row">
					  <div>
						  <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/justify-content" target="_blank"
							  rel="noopener">justify-content</a>: <span class="default">flex-start</span>;
					  </div>
				  ...
				  <h4>Try it out</h4>
				  <div class="interactive-playground flex-container">
					  <button class="button selected" data-js-class="justify-content-flex-start"
						  type="button">flex-start</button>
					  ...
					  <button class="button" data-js-class="justify-content-space-between"
						  type="button">space-between</button>
					  <button class="button" data-js-class="justify-content-space-around"
						  type="button">space-around</button>
					  <button class="button" data-js-class="justify-content-space-evenly"
						  type="button">space-evenly</button>
			  ...
			  <div class="group">
				  ...
				  <div class="row">
					  <div>
						  <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/align-items" target="_blank"
							  rel="noopener">align-items</a>: <span class="default">stretch</span>;
					  </div>
			  ...
			  <div class="group">
				  ...
				  <div class="row">
					  <div>
						  <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/align-content" target="_blank"
							  rel="noopener">align-content</a>: <span class="default">stretch</span>;
					  </div>
				  ...
				  <div class="interactive-playground flex-container has-height has-width flex-wrap">
					  ...
					  <button class="button" data-js-class="align-content-space-between"
						  type="button">space-between</button>
					  <button class="button" data-js-class="align-content-space-around"
						  type="button">space-around</button>
		  ...
		  <div class="container">
			  ...
			  <div class="group">
				  ...
				  <div class="row">
					  <div>
						  <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/order" target="_blank"
							  rel="noopener">order</a>: <span class="default">0</span>;
					  </div>
			  ...
			  <div class="group">
				  <h3 id="flexShorthand">Flex (shorthand)</h3>
  
				  <div class="row">
					  <div>
						  <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/flex" target="_blank"
							  rel="noopener">flex</a>: <span class="default">0 1 auto;</span> <span
							  class="shorthand-hint">(flex-grow flex-shrink flex-basis)</span>
					  </div>
				  </div>
			  </div>
			  ...
			  <div class="group">
				  ...
				  <div class="row">
					  <div><a href="https://developer.mozilla.org/en-US/docs/Web/CSS/flex-grow" target="_blank"
							  rel="noopener">flex-grow</a>:
			  ...
			  <div class="group">
				  ...
				  <div class="row">
					  <div>
						  <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/flex-grow" target="_blank"
							  rel="noopener">flex-shrink</a>: <span class="default">0</span>;
					  </div>
			  ...
			  <div class="group">
				  ...
				  <div class="row">
					  <div>
						  <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/flex-basis" target="_blank"
							  rel="noopener">flex-basis</a>: <span class="default">auto</span>;
					  </div>
				  </div>
			  </div>
			  ...
			  <div class="group">
				  ...
				  <div class="row">
					  <div>
						  <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/align-self" target="_blank"
							  rel="noopener">align-self</a>: <span class="default">auto</span>;
					  </div>
	  ...
	  <script src="${scriptPath}/menu.js"></script>
  </body>
